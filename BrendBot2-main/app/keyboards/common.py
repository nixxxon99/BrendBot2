...
MAIN_KB = kb("🗂️ Меню брендов", "🧠 Тренажёр знаний", "📊 Моя статистика", "🧩 Квиз", "📸 Фото-анализ", "👤 Профиль", "📦 POSM списание", width=2)
ADMIN_MAIN_KB = kb("🗂️ Меню брендов", "🧠 Тренажёр знаний", "📊 Моя статистика", "🧩 Квиз", "📸 Фото-анализ", "👤 Профиль", "📦 POSM списание", "👑 Админ-панель", width=2)
