...
_MODEL = "gemini-1.5-flash"  # быстрый и недорогой
_SYSTEM_STYLE = (
...
def _sync_generate(query: str, results: Optional[Dict[str, Any]]) -> str:
    ...
    try:
        ...
        # Простая защита: если Gemini вернул пусто — дадим заглушку
        if not text:
